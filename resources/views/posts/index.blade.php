                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h2>{{ config('app.name') }}</h2>
                        ...
                        <a href="#" class="btn btn-outline-success btn-lg">Read more</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="">
                         ...
                         <div class="card m-auto p-3">
                              <div class="square">
                                   ...
                                   <div><a href="posts/{{ $post->id }}" target="_" class="button">Read more</a> Created by: {{ $post->user->name }}</div>
                              </div>
                         </div>
               ...
               <div class="well">
                    <div class="row">
                         <form action="{{ route('search') }}" method="get">
                              <input autocomplete="off" class="form-control" name="search" placeholder="Search posts...">
                         </form>
